# Evidence Type: Description Only

## Purpose

This capability introduces a `:description_only` evidence type that allows users to create evidence records without requiring file attachments or external links. This provides flexibility for documentation-based evidence where only a textual description is needed, making the evidence creation workflow more streamlined and optional for attachment-based evidence.
