# Evidence Entity Linking

## Purpose

This capability enables users to create and manage relationships between evidence and other entities (assumptions, threats, mitigations) through an intuitive UI with linking buttons, modals, and persistent relationship management.
